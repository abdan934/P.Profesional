...
@section('isi-konten')
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    ...
                    <button type="button" class="btn btn-outline-primary col-2 m-3 me-auto" data-bs-toggle="modal" data-bs-target="#ModalAddSift"><i class="bi bi-plus-circle-fill"></i> &nbsp;Tambah</a></button>
